...
const BulkImportPage: React.FC = () => {
  ...
  const { bulkAddRecipes } = useRecipes()
  ...
  const handleImportSelected = () => {
    ...
    bulkAddRecipes(recipesToImport)
    navigate('/recipes')
  }
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Import multiple recipes from CSV or JSON files.
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="card">
              ...
              <div className="flex justify-end mt-6">
                ...
                >
                  Import {selectedRecipes.size} Selected Recipes
                </button>
              </div>
            </div>
